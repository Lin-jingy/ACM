...
int main(){
    std::string dataID = "17";
    std::string address1 = std::format("C:/Users/123/Desktop/programming/VScode/ACM/data/15/data/{}.in",dataID);
    std::string address2 = std::format("C:/Users/123/Desktop/programming/VScode/ACM/data/15/data/{}.out",dataID);
