...
int main(){
    for(int I = 1; I <= 10; ++I) {
        ...
        freopen(std::format("C:/Users/123/Desktop/programming/VScode/ACM/data/2-4/data/{}.in", I).c_str(), "r", stdin);
        freopen(std::format("C:/Users/123/Desktop/programming/VScode/ACM/data/2-4/data/{}.out", I).c_str(), "w", stdout);
